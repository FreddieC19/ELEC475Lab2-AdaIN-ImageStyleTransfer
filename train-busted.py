...
def main():
    ...
    parser.add_argument("-gamma", type=float, default=0.1, help="Alpha blending parameter for AdaIN")
    ...
    # Modify the optimizer and learning rate
    optimizer = optim.Adam(model.decoder.parameters(), lr=1e-6)
    ...
    # Use larger image size for better detail preservation
    ...
    for epoch in range(args.e):
        for i, (content_images, style_images) in enumerate(zip(content_loader, style_loader)):
            ...
            # Experiment with different style loss weights
